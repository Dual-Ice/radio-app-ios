...
final class SearchBarView: UIView {
    ...
    private lazy var searchBar: UISearchBar = {
        ...
        let image = searchIcon?.withTintColor(.clear, renderingMode: .alwaysOriginal)
        ...
        search.searchTextField.layer.borderColor = UIColor.white.withAlphaComponent(0.5).cgColor
